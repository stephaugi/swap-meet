class Vendor:
    ...
    def get_by_id(self, item_id):
        ...
        Args: item_id (int)
        Returns: item with the matching id or None if not found
        """
    ...
    def swap_first_item(self, other_vendor):
        ...
        Args: instance of another Vendor(other_vendor)
    ...
    def get_best_by_category(self, category):
        ...
        best_by_category = items_in_category[0]
        for object in items_in_category[1:]:
